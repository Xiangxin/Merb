...
//     Merb may be freely distributed under the MIT license.
...
(function(){
  ...
  // Save the previous value of the `Merb` variable, so that it can be
  // restored later on, if `noConflict` is used.
  var previousMerb = root.Merb;
  ...
  // The top-level namespace. All public Merb classes and modules will
  ...
  // For Merb's purposes, jQuery, Zepto, Ender, or My Library (kidding) owns
  // the `$` variable.
  Merb.$ = root.jQuery || root.Zepto || root.ender || root.$;

  // Runs Merb.js in *noConflict* mode, returning the `Merb` variable
  // to its previous owner. Returns a reference to this Merb object.
  Merb.noConflict = function() {
    root.Merb = previousMerb;
    return this;
  };
  ...
  Merb.emulateHTTP = false;

  // Turn on `emulateJSON` to support legacy servers that can't deal with direct
  // `application/json` requests ... will encode the body as
  // `application/x-www-form-urlencoded` instead and will send the model in a
  // form param named `model`.
  Merb.emulateJSON = false;
  ...
  // Merb **Models** are the basic data object in the framework --
  ...
  _.extend(Model.prototype, Events, {
    ...
    // Proxy `Merb.sync` by default -- but override this if you need
    ...
    // using Merb's restful methods, override this to change the endpoint
    // that will be called.
    url: function() {
  ...
  // If models tend to represent a single row of data, a Merb Collection is
  ...
  var Collection = Merb.Collection = function(models, options) {
    options || (options = {});
  ...
  _.extend(Collection.prototype, Events, {
    ...
    // The default model for a collection is just a **Merb.Model**.
  ...
  // 90% of the core usefulness of Merb Collections is actually implemented
  // right here:
  ...
  // Merb Views are almost more convention than they are actual code. A View
  ...
  // Creating a Merb.View creates its initial element outside of the DOM,
  ...
  _.extend(View.prototype, Events, {
    ...
    setElement: function(element, delegate) {
      ...
      this.$el = element instanceof Merb.$ ? element : Merb.$(element);
      this.el = this.$el[0];
    ...
    _ensureElement: function() {
      if (!this.el) {
        ...
        var $el = Merb.$('<' + _.result(this, 'tagName') + '>').attr(attrs);
  ...
  Merb.ajax = function() {
    return Merb.$.ajax.apply(Merb.$, arguments);
  };
  ...
  _.extend(History.prototype, Events, {
    ...
    start: function(options) {
      ...
      if (oldIE && this._wantsHashChange) {
        this.iframe = Merb.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo('body')[0].contentWindow;
      ...
      if (this._hasPushState) {
        Merb.$(window).on('popstate', this.checkUrl);
      } else if (this._wantsHashChange && ('onhashchange' in window) && !oldIE) {
        Merb.$(window).on('hashchange', this.checkUrl);
    ...
    stop: function() {
      Merb.$(window).off('popstate', this.checkUrl).off('hashchange', this.checkUrl);
...
(function() { this.JST || (this.JST = {}); this.JST["movies/index"] = function(__obj) {
    if (!__obj) __obj = {};
...
(function() { this.JST || (this.JST = {}); this.JST["reviews/index"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
(function() { this.JST || (this.JST = {}); this.JST["users/index"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
...
//Merb to model client-side
	//MODEL
	Movie = Merb.Model.extend({ 
		url : function(){
...
(function() {
  ...
  MovieReview.Models.Movie = (function(_super) {
...
(function() {
  ...
  MovieReview.Models.Review = (function(_super) {
...
(function() {
  ...
  MovieReview.Models.User = (function(_super) {
...
(function() {
  ...
  MovieReview.Collections.Movies = (function(_super) {
    __extends(Movies, _super);

    function Movies() {
      _ref = Movies.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Movies.prototype.model = MovieReview.Models.Movie;
...
(function() {
  ...
  MovieReview.Collections.Reviews = (function(_super) {
    __extends(Reviews, _super);

    function Reviews() {
      _ref = Reviews.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Reviews.prototype.model = MovieReview.Models.Review;
...
(function() {
  ...
  MovieReview.Collections.Users = (function(_super) {
    ...
    Users.prototype.model = MovieReview.Models.User;
...
(function() {
  ...
  MovieReview.Views.MoviesIndex = (function(_super) {
    __extends(MoviesIndex, _super);

    function MoviesIndex() {
      _ref = MoviesIndex.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    MoviesIndex.prototype.template = JST['movies/index'];
...
(function() {
  ...
  MovieReview.Views.ReviewsIndex = (function(_super) {
    __extends(ReviewsIndex, _super);

    function ReviewsIndex() {
      _ref = ReviewsIndex.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    ReviewsIndex.prototype.template = JST['reviews/index'];
...
(function() {
  ...
  MovieReview.Views.UsersIndex = (function(_super) {
    __extends(UsersIndex, _super);

    function UsersIndex() {
      _ref = UsersIndex.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  MovieReview.Routers.Movies = (function(_super) {
    __extends(Movies, _super);
...
(function() {
  ...
  MovieReview.Routers.Reviews = (function(_super) {
    __extends(Reviews, _super);
...
(function() {
  ...
  MovieReview.Routers.Users = (function(_super) {
    __extends(Users, _super);
